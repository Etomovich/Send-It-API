...
from .views.parcelviews import ChangeParcelDestination
from .views.userviews import UserRegistration, TokenRefresh
from .views.userviews import GetAllUsers, UserLogin 

version_2 = Blueprint('v2', __name__)

api = Api(version_2, prefix="/api/v2")

api.add_resource(SpecificParcel, '/parcels/<int:order_id>')
