...
class UserLogin(Resource):
    ...
    def post(self):
        ...
        parser=reqparse.RequestParser()
        parser.add_argument('username', help = 'invalid name, check it again', required = True)
        parser.add_argument('password', help = 'invalid name, check it again', required = True)
        data = parser.parse_args()
